...
import com.vbarca.vyn.model.Feedback;
...
public class ContactoFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        enviar = view.findViewById(R.id.btEnviarFeedback);
        comentario = view.findViewById(R.id.etFeedback);
    ...
    public void onClick(View view) {
        ...
        base.getDatabaseReference().child("Feedback").child(feedback.getUid()).setValue(feedback);
        comentario.setText("");
        Toast.makeText(getContext(), "GRACIAS POR TU FEEDBACK", Toast.LENGTH_SHORT).show();
